...
//splice(indexOfHighest, (length - 1) - indexOfHighest)
...
let best = stockPrices => {
    ...
    if(highestPriceIndex === 0){
        ...
        stockPrices.splice(highestPriceIndex, (stockPrices.length - 1));
    }
    //console.log(stockPrices);
    let lowestPrice = getLowestPrice(stockPrices);
...
let test = [99, 100, 1, 24, 82, 90, 12, 39];
